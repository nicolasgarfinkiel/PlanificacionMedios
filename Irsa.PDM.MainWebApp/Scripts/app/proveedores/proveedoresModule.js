angular.module('irsa.pdm.proveedores', [
    'irsa.pdm.proveedores.ctrl.list',
    'irsa.pdm.proveedores.ctrl.edit',
    ...
    function ($routeProvider, $locationProvider, $httpProvider) {
        ...
        $routeProvider.when('/', {
            templateUrl: 'proveedores/list',
            controller: 'listCtrl'
        });
              
        $routeProvider.when('/create', {
            templateUrl: 'proveedores/edit',
            controller: 'editCtrl'
        });
